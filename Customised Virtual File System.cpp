...
#define MAXINODE 50         // macro-->Capital(convension)
...
void man(char *name)
{
    ...
    else if(strcmp(name,"read") == 0)
    {
        ...
        printf("Uasage : read File_name No_Of_Bytes_To_Read\n");
    }
    else if(strcmp(name,"write") == 0)
    {
        printf("Description : Used to write into regular file\n");
        printf("Uasage : write File_name No_Of_Bytes_To_Read\n");
    }
    ...
    else if(strcmp(name,"truncate") == 0)
    {
        ...
        printf("Uasage : truncate File_name\n");
    }
    else if(strcmp(name,"open") == 0)
    {
        printf("Description : Used to open existing file\n");
        printf("Uasage : open File_name mode\n");
    }
    else if(strcmp(name,"close") == 0)
    {
        printf("Description : Used to close opened file\n");
        printf("Uasage : close File_Name\n");
    }
    ...
    else if(strcmp(name,"lseek") == 0)
    {
        ...
        printf("Uasage : lseek File_Name ChangeInOfset StartPoint\n");
    }
...
void DisplayHelp()
{
    ...
    printf("clear : To clear onsole\n");
    printf("Open : To open the file\n");
    printf("Close : To close the file\n");
    printf("Closeall : To close all opened files\n");
    printf("read : To read the contents from file\n");
    printf("write : To write contents into file\n");
    printf("exit : To Terminae file system\n");
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);
            ...
            else if(count == 2)
            {
                    ...
                    else if(strcmp(command[0],"trucate") == 0)
                    {
...
/*
 ...
 command - 
    i.man create
    ii.create Marvellous.txt 3
    iii.create Demo.txt 3
    iv.stat Marvellous.txt
    v.ls
    vi.man write
    vii.write Marvellous.txt
    Enter the data :
    Hello World
    viii.stat marvellous.txt
    Acual File size get change ( Output )
    ix.ls
    x.write PPA.txt
    Error : Incorrect parameter
    xi.write Marvellous.txt
    Enter the data :
    Demo
    xii.man read
    xiii.read Marvellous.txt 5
    14.read Marvellous.txt 7
    stat - statistics



    Use of project - Reasearch base project
